#/////////////////////////////////////////////////////////////////////////////
#/// @file FlashMemoryHashTestFaultInjectionTest4.py
#///
#/// This Python script allows to verify HyperLoader's ability to verify
#/// firmware images using their certificates and load Safeboot if normal image
#/// is invalid.
#/// The script injects code which corrupts normal firmware's certificate 
#/// during power up.
#///
