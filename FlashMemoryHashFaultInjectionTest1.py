#/////////////////////////////////////////////////////////////////////////////
#/// @file FlashMemoryHashTestFaultInjectionTest1.py
#///
#/// This Python script allows to verify Boot ROM's ability to detect that both
#/// images of HyperLoaderInit are corrupted. Boot ROM should refrain from
#/// loading either copy in such case.
#/// The script injects code which corrupts both images of HLI in SPI NOR
#/// during power up.
#///
...
// Fault Injection Code End
    ...
    // Fault Injection Code Start
    bsp_ASSERT(-1 != g_CorruptEarlyBootComponent(0));   // Primary HLI
